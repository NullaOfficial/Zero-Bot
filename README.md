...
- #### Descripción:
	...
	| Makeblock MegaPi <div  align="center"> ![Raspberry](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR97vGNS_Bob3FpycF1ZooG3lmox1eXxC0DyA&s) </div> | La elección de la placa **Makeblock MegaPi** (basada en el núcleo **ATmega2560**) como microcontrolador central se debió a su capacidad para gestionar en paralelo múltiples sensores y motores de alta corriente, superando las limitaciones de opciones más simples como Arduino Uno o Nano. Su arquitectura simplifica el cableado gracias a sus interfaces plug-and-play y, aunque está diseñada para acoplarse físicamente sobre una Raspberry Pi, se optó por conectarla exclusivamente vía **USB** para la transferencia de datos. Esta configuración optimiza el espacio disponible dentro del robot, aprovecha que la placa cuenta con su propia fuente de alimentación y elimina los riesgos de dañar los componentes principales durante el proceso de soldadura. |
	| a | a |
	| a | a |
	| a | a |
